...
<meta property="og:url" content="https://zyx190.github.io/Go">
...
<div class="title-right">
    <a href="https://zyx190.github.io/Go/tag.html" id="buttonSearch" class="btn btn-invisible circle" title="搜索">
    ...
    <a href="https://zyx190.github.io/Go/rss.xml" target="_blank" id="buttonRSS" class="btn btn-invisible circle" title="RSS">
        <svg class="octicon" width="16" height="16" >
...
<a class="SideNav-item d-flex flex-items-center flex-justify-between" href="post/111111111111111.html">
    <div class="d-flex flex-items-center">
        <svg class="SideNav-icon octicon" style="witdh:16px;height:16px"><path class="svgTop0" d=""></path>
        </svg>
        <span class="listTitle">111111111111111</span>
    </div>
    <div class="listLabels">
        
        <span class="Label LabelName" style="background-color:#7057ff"><object><a style="color:#fff" href="tag.html#good first issue">good first issue</a></object></span>
        <span class="Label LabelTime" style="background-color:#bc4c00">2024-10-27</span>
    </div>
</a>
</nav>
</div>
    <div id="footer"><div id="footer1">Copyright © <span id="copyrightYear"></span> <a href="https://zyx190.github.io/Go">Blog Title</a></div>
<div id="footer2">
...
for(var i=0;i<iconPost.length;i++){
    iconPost[i].setAttribute("d",IconList["docs/post"]);
}
